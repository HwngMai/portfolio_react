  ...
  return (
    <div className='gallery container mx-auto lg:h-5/6 md:h-auto my-10'>
      <div className='gallery__para flex flex-col md:mx-20 sm:mx-5 md:justify-center md:items-center lg:justify-start lg:items-start'>
        ...
        <p className='gallery__para__para text-center sm:text-base md:text-xl'>
          My gears: Sony a6400 | Sigma 16 f1.4 | Sony FE 85 f1.8 | Sony FE
          24-105 F4 G | Zhiyun crane 2
        </p>
        <p className='sm:text-base md:text-xl text-center '>
          Want to see more?  
          <a
            target='_blank'
            ...
            {" "}
            <p className='sm:text-base md:text-xl underline text-center'>  My Flickr</p>
          </a>{" "}
        </p>
