...
const Header = () => {
  return (
    <div className='text-white header z-10 inset-x-0 mx-auto fixed mt-5 container top-0 flex justify-between items-center'>
      ...
      <div className='header__nav flex relative justify-center items-center gap-5'>
        <p className='header__nav__text text-xl pr-10 underline'> Let's start! </p>
